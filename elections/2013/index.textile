...
h3(#tetrault). "Joel Tetrault":http://www.cs.rochester.edu/~tetreaul/
...
h3(#erk). "Katrin Erk":http://www.katrinerk.com/
...
h3(#hirschberg). "Julia Hirschberg":http://www.cs.columbia.edu/~julia/
...
h3(#inkpen). "Diana Inkpen":http://www.site.uottawa.ca/~diana/
...
h3(#nenkova). "Ani Nenkova":http://www.cis.upenn.edu/~nenkova/
...
h3(#ng). "Vincent Ng":http://www.hlt.utdallas.edu/~vince/
...
h3(#quirk). "Chris Quirk":http://research.microsoft.com/en-us/people/chrisq/
...
h3(#schuler). "William Schuler":http://www.ling.ohio-state.edu/~schuler/
...
h3(#zettlemoyer). "Luke Zettlemoyer":http://homes.cs.washington.edu/~lsz/
