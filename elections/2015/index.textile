...
h2. Treasurer (one opening):

h3. <a name="tetreault"></a> "Joel Tetreault":http://www.cs.rochester.edu/~tetreaul/
...
h3. <a name="xia"></a> "Fei Xia":https://faculty.washington.edu/fxia/
...
h3. <a name="may"></a> "Jonathan May":http://www.isi.edu/~jonmay/
...
h3. <a name="post"></a> "Matt Post":http://cs.jhu.edu/~post/
...
h3. <a name="ji"></a> "Heng Ji":http://nlp.cs.rpi.edu/hengji.html
