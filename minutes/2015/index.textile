...
* The idea of tracking these stars over time was discussed, with Ed suggesting the name ACL Reviewer Honor Roll for this site.  If the Honor Roll were to only list those awarded stars (rather than those not awareded stars, and how often), it seemed unlikely to be objectionable to the membership.
...
* **ACTION ITEM** Mike and Matt will coordinate with David Jurgens on steps to take in this direction for SemEval 2016, including any necessary changes to START, and likewise with Ani and Owen on making NAACL 2016 best reviewer awards more visible.
