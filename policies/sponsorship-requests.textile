...
In either case, there is no implication that ACL will host proceedings in the ACL Anthology, though the board will entertain an additional request to recommend inclusion of the proceedings to the Anthology Editor.  This request should indicate how the submissions will be reviewed and selected for inclusion in the proceedings.
