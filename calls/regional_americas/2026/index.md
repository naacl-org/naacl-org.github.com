---
layout: default
title: "2026 Regional Americas Fund CFP"
root: ../../../
---

[English](#naacl-regional-americas-fund-call-for-proposals)

[Español](#convocatoria-de-propuestas-para-el-fondo-de-desarrollo-para-regiones-americanas-naacl)
...
Proposals will be evaluated by a committee consisting of members of the NAACL Executive Board. Awardees must provide a post-facto report. If you have any questions about this CFP please send them to <naacl-exec@googlegroups.com> . 

Proposals may be submitted in any preferred language, as long as an English translation is also provided. The online form for submissions is here: <https://forms.gle/XPxN3MuSVo7rnma57>

Reports from previous awardees can be found here: <https://naacl.org/calls/regional_americas/>
...
NAACL reconoce que cada región tiene sus necesidades y preocupaciones específicas, por lo que estamos abiertos a una amplia diversidad de propuestas, con el requisito único siendo que los fondos otorgados sean destinados a apoyar a personas, instituciones o eventos ubicados en cualquier parte de las Américas.

Ejemplos de propuestas que pueden ayudar a crear comunidad en las Américas:

- Congresos o talleres (workshops) regionales.

- Clases de Procesamiento del Lenguaje Natural (PLN) y Lingüística Computacional en facultades y universidades

- Participación de estudiantes en congresos, escuelas de verano, y concursos/competiciones de PLN/LC

El apoyo económico podría utilizarse para compra de materiales, difusión/streaming, archivado/hosting, viajes, o cualquier otra cosa que las comunidades consideren útil.

Téngase en cuenta que este fondo no puede ser utilizado para a apoyar el viaje de estudiantes a conferencias, ya que existe un fondo específico para ese propósito. Asimismo, NAACL no apoyará viajes a o desde lugares fuera de las Américas.

Las propuestas serán evaluadas por un comité formado por miembros de la Junta Directiva de NAACL, y las personas galardonadas deberán entregar un informe final. Si tiene cualquier duda sobre esta convocatoria, por favor, envíela a <naacl-exec@googlegroups.com> .

Las propuestas pueden enviarse en cualquier lengua, siempre que se proporcione también una traducción al inglés. El formulario de envío online está disponible aquí: <https://forms.gle/XPxN3MuSVo7rnma57>

Informes de los ganadores anteriores se pueden encontrar aquí: <https://naacl.org/calls/regional_americas/>
...
- Cours de traitement du langage naturel (TALN) et de linguistique informatique (LI) dans les collèges et universités

- Participation des étudiants aux conférences, aux écoles d'été et aux compétitions de TALN/LI

Le soutien financier pourra être utilisé pour du matériel, la diffusion / streaming, l'archivage / hébergement, voyages ou tout autre élément que les communautés pourraient trouver utile. D'autres propositions sont aussi les bienvenues!

Veuillez noter que ce fonds n'est pas destiné à soutenir le voyage des étudiants aux conférences, car un fonds distinct est disponible à cet effet. NAACL ne prendra uniquement en charge les voyages à destination et/ou en provenance des Amériques.

Les propositions seront évaluées par un comité composé de membres du conseil exécutif de NAACL. Les récipiendaires devront fournir un rapport a posteriori. Si vous avez des questions sur ce CFP, veuillez les envoyer à : <naacl-exec@googlegroups.com>.

Les propositions peuvent être soumises dans la langue de votre choix, à condition qu'une traduction en anglais soit également fournie. Le formulaire en ligne pour les soumissions est accessible ici:  <https://forms.gle/XPxN3MuSVo7rnma57>

Les rapports des lauréats précédents peuvent être consultés ici: <https://naacl.org/calls/regional_americas/>
...
Voorstellen worden beoordeeld door een commissie bestaande uit leden van de NAACL Raad van Bestuur. Awardees moeten een post-facto rapport indienen. Als u vragen heeft over dit GVB, stuur deze dan naar <naacl-exec@googlegroups.com>.

Voorstellen kunnen in elke gewenste taal worden ingediend, mits er ook een Engelse vertaling wordt verstrekt: <https://forms.gle/XPxN3MuSVo7rnma57>

Rapporten van eerdere winnaars zijn hier te vinden: <https://naacl.org/calls/regional_americas/>
