...
<div class="more">
<ul class="navigate">
    {% for year in (2011..2012) limit:5 %}
    <li><a href="{{ root }}officers-{{ year }}.html">{{ year }}</a></li>
    {% endfor %}
    <li><a href="{{ root }}index.html">All</a></li>
</ul>
</div>
...
h2. Past Chair (2010-2011) | <a href="http://www.cs.pitt.edu/~hwa">Rebecca Hwa</a> | University of Pittsburgh

!>http://www.cs.pitt.edu/people/faculty/hwa.jpg(Rebecca Hwa)!
